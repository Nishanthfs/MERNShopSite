...
const AdminEditProduct = ({
    ...
    const[data,setdata]=useState({
      ...
      const handleSumbit=async(e)=>{
        e.preventDefault()
        const responce = await fetch(summeryapi.updateProduct.url,{
  ...
  return (
          ...
          <label htmlFor='uploadImageInput'>    
           ...
           <label htmlFor="sellingPrice" className='mt-3'>Selling Price :</label>
            <input 
             ...
             <textarea className='h-28 bg-slate-100 border resize-none p-1'placeholder="enter product description" name='description' rows={3} onChange={handleonchange}>
    ...
    // <div className='fixed bottom-0 top-0 right-0 left-0 bg-red-600 flex justify-center items-center'>
    //     AdminEditProduct
    // </div>
