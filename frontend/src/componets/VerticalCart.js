...
const VerticalCart = ({loading,data = []}) => {
  ...
  return (
    <div className='grid grid-cols-[repeat(auto-fit,minmax(260px,300px))] justify-center gap-4 md:justify-between md:gap-3 overflow-x-scroll scrollbar-none transition-all'> 
